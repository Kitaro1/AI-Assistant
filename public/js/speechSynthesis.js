...
document.body.onload = () =>{
    ...
    for(let voice of temporal_voices){
        if(voice.lang.includes("es-ES") && voice.name.includes("Google español")){ // Filtra las voces en español y con género masculino
            voices.push(voice);
            console.log(voice)
        }
    }
    ...
    if(voices.length<1){
        console.log("Tu navegador no tiene voces masculinas en español.");
        return -1;
    }
